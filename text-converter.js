function decodeIso88591ToUtf8(encodedStr) {
    var encoder = new TextEncoder();
    var decoder = new TextDecoder("iso-8859-1");
    // Convert the string to ISO-8859-1 bytes
    var isoBytes = encoder.encode(encodedStr);
...
input.forEach(function (str) {
    console.log("Encoded: ".concat(str));
    console.log("Decoded: ".concat(decodeIso88591ToUtf8(str)));
});
